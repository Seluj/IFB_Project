...
//définition de deux structures essentiel au programme
typedef struct {
    char** grille;
    int largeur;
    int hauteur;
...
/**
 * initialise la grille et demande le nombre de pions à aligner
 ...
 * @param numéro de la colonne +1 où faire "tomber" le jeton
